    ...
    <main className="max-w-2xl mx-auto py-10 px-4">
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          convenience only. We do not verify, endorse, or take responsibility for the content,
          privacy policies, or practices of any third-party sites. Visiting external links is at
          your own risk.
        </p>
      </section>
      <section className="mb-6">
        ...
        <p>
          Users are expected to communicate respectfully when using any chat systems or contact
          forms on this site. Please refrain from using offensive, abusive, or inappropriate
          language. Messages containing such content may be ignored or removed.
        </p>
        <p className="mt-2">
          <strong>Don’t post unlawful or inappropriate content.</strong> Don’t post anything that is
        ...
        <p className="mt-2">
          ...
          promotional material, or any junk mail, spam, or chain letters. Don’t run mail lists,
      ...
      <section>
        ...
        <p>
          By using this website, you agree to abide by these terms. We reserve the right to update
