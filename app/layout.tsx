  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta
          name="description"
          content="Portfolio of Debasis Biswas - BCA Student, Cybersecurity Enthusiast, Network Engineering, and Linux Troubleshooter"
        />
        <meta
          name="keywords"
          content="Debasis Biswas, Cybersecurity, BCA Student, Network Engineering, Linux, Portfolio"
        />
