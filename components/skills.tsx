...
function TechTile({ item }: { item: TechItem }) {
  return (
    <div className="rounded-md border border-white/10 bg-white/5 p-3 transition hover:-translate-y-0.5 hover:border-white/20 hover:bg-white/10">
      ...
      {item.note ? <p className="mt-1 text-xs leading-relaxed text-gray-200">{item.note}</p> : null}
    </div>
  );
}
      ...
      items: [
        {
          name: 'Kali Linux',
          icon: 'kalilinux',
          note: 'Security testing environment (not a production OS)',
        },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Python', icon: 'python', note: 'Automation, scripting, tooling' },
        {
          ...
          icon: 'mysql',
          note: 'Relational modeling and query fundamentals',
        },
      ...
      <div className="container mx-auto px-2 sm:px-4">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="mx-auto max-w-3xl text-sm sm:text-base leading-relaxed text-gray-200">
            Proof over buzzwords: I deploy, secure, and operate systems — automate delivery, harden
            hosts, and keep services reliable in real environments.
          </p>
