        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div ref={ref} variants={containerVariants} initial="hidden" animate={controls} className="space-y-6">
            <motion.h3 variants={itemVariants} className="text-2xl font-bold text-blue-500">
              BCA Student & Cybersecurity, DevOps, and Cloud Security Enthusiast
            </motion.h3>
            ...
            <motion.p variants={itemVariants} className="text-gray-300">
              ...
              Technology, focused on cybersecurity, DevOps, cloud security, and DevSecOps.
            </motion.p>

            <motion.p variants={itemVariants} className="text-gray-300">
              My journey in technology is driven by curiosity and a desire to build secure, reliable, and scalable
              systems. I'm constantly learning and exploring new technologies to expand my skillset.
            </motion.p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-[#111827] p-6 rounded-lg hover-lift hover-glow transition-all">
              ...
              <p className="text-gray-400">Secure CI/CD, automation, and infrastructure workflows.</p>
            </div>
            ...
            <div className="bg-[#111827] p-6 rounded-lg hover-lift hover-glow transition-all">
              ...
              <p className="text-gray-400">Cloud posture, access control, and secure deployment practices.</p>
            </div>
            ...
            <div className="bg-[#111827] p-6 rounded-lg hover-lift hover-glow transition-all">
              ...
              <p className="text-gray-400">Automation, deployment pipelines, and reliable system operations.</p>
            </div>
          </div>
        </div>
      </div>
